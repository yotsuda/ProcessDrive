#
# Module manifest for module 'ProcessDrive'
#
...
Description = 'Navigate Windows process tree as a PowerShell drive. A CLI alternative to Process Explorer.'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'Process', 'Tree', 'Provider', 'Drive', 'ProcessExplorer', 'Windows'
